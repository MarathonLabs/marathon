...
import com.malinskiy.marathon.tasks.prepare.DownloadTask
import com.malinskiy.marathon.tasks.prepare.UnzipTask
import com.malinskiy.marathon.tasks.run.MarathonRunTask
...
class MarathonPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        registerPrepareMarathonTasks(project)
    ...
    private fun registerPrepareMarathonTasks(project: Project) {
        val downloadTask = project.tasks.register("downloadMarathon", DownloadTask::class.java)
        downloadTask.configure {

        }
        val unzipTask = project.tasks.register("unzipMarathon", UnzipTask::class.java)
        unzipTask.configure {
