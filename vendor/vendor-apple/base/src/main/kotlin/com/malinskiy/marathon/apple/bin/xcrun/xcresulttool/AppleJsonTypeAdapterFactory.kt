            ...
            override fun modifyDeserializer(
                ...
                return when (beanDesc?.beanClass) {
                    String::class.java, java.lang.String::class.java -> {
                        AppleJsonDeserializer(String::class.java, deserializer as JsonDeserializer<String>)
                    }

                    java.util.Date::class.java -> AppleJsonDeserializer(
                        Date::class.java,
                        deserializer as JsonDeserializer<Date>
                    )

                    Double::class.java, java.lang.Double::class.java -> {
                        AppleJsonDeserializer(Double::class.java, deserializer as JsonDeserializer<Double>)
                    }

                    Int::class.java, java.lang.Integer::class.java -> {
                        AppleJsonDeserializer(Int::class.java, deserializer as JsonDeserializer<Int>)
                    }

                    Boolean::class.java, java.lang.Boolean::class.java -> {
                        AppleJsonDeserializer(Boolean::class.java, deserializer as JsonDeserializer<Boolean>)
                    }
