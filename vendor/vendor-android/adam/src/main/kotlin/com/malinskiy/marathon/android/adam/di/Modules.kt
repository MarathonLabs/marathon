...
import com.malinskiy.marathon.android.LocalTestParser
import com.malinskiy.marathon.android.adam.AdamDeviceProvider
import com.malinskiy.marathon.android.adam.RemoteTestParser
...
val adamModule = module {
    ...
    single<TestParser?> {
        ...
        when {
            testParserConfiguration != null && testParserConfiguration is TestParserConfiguration.RemoteTestParserConfiguration -> RemoteTestParser(
                get(),
                get(),
                get()
            )
            else -> LocalTestParser(get(), get())
        }
    }
}
