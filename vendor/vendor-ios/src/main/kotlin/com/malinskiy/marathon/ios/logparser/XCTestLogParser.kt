...
import com.malinskiy.marathon.execution.listener.CompositeLineListener
...
class XCTestLogParser(
    ...
    private val underlyingLogParser: LineListener
    private val diagnosticLogsPathFinder: DiagnosticLogsPathFinder = DiagnosticLogsPathFinder()
    private val sessionResultsPathFinder: SessionResultsPathFinder = SessionResultsPathFinder()

    init {
        underlyingLogParser = CompositeLineListener(
            listOf(
