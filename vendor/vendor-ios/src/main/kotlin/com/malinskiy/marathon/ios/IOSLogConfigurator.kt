...
class IOSLogConfigurator(private val vendorConfiguration: VendorConfiguration.IOSConfiguration) : MarathonLogConfigurator {
    override fun configure() {
        ...
        // silence the noise
        listOf(
            TimelineSummaryProvider::class.java.simpleName,
