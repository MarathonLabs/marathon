...
sealed class DevicePoolMessage {
    ...
    data class TestExecutionFinished(val device: Device, val sender: DeviceActor) : DevicePoolMessage()
    data class Ready(val device: Device, val sender: DeviceActor) : DevicePoolMessage()
