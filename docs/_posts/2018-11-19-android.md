...
marathon {
  fileSyncConfiguration {
    push.add(new FileSyncEntry("/home/user/folder"))
    push.add(new FileSyncEntry("/home/user/testfile.txt"))
  }
}
```
...
marathon {
  fileSyncConfiguration {
    push.add(FileSyncEntry("/home/user/folder"))
    push.add(FileSyncEntry("/home/user/testfile.txt"))
  }
}
```
