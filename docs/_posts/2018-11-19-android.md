...
With the introductino of [adam][6] we can precisely control the timeout of individual requests. Here is how you can use it:

{% tabs vendor-module %} {% tab vendor-module Marathonfile %}
...
{% endtab %} {% tab vendor-module Gradle %}
