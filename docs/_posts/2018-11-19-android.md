...
## Push files to device before each test

Current version push all files in **/data/local/tmp/resources** 
...
vendorConfiguration:
  ...
  fileSyncConfiguration:
    push:
    - relativePath: "/home/user/folder"
    - relativePath: "/home/user/testfile.txt"
```
