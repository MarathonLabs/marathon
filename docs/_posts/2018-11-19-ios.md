...
## xcResultBundlePath
Use this option to specify the path to storing the iOS Test Result i.e. xcResultBundlePath. Default is xcode's derieved data
```yaml
xcResultBundlePath: "derived-data/test/resultBundle"
```
